#############################################
##    Load masterBedroom controlCommands
#############################################
print('Load masterBedroom controlCommands')
...
controlWords = {
	...
	"Ok": [
		{"controlWord": "Ok", "hidCode": 0x41, "hidReport": 0x02}
	],
	...
	"OnToggle": [
		{"controlWord": "OnToggle", "hidCode": 0x30, "hidReport": 2},
	]
}
